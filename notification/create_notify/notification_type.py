NOTIFICATION_TYPE = {
    'added_in_ws': 'Вы добавлены в рабочее пространство "{ws}"',
    'del_from_ws': 'Вы исключены из рабочего пространства "{ws}"',
    ...
    'change_deadline': '{user} изменил(а) срок на {date} для карточки "<a href="{link}">{task}</a>"',
